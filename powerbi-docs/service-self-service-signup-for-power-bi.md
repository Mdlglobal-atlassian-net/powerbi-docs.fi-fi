...
1. Näyttöön saattaa tulla jokin näistä valintaikkunoista. 
...
1. Tässä vaiheessa joudut ehkä odottamaan, jos Microsoft [määrittää uuden vuokraajan](service-admin-signing-up-for-power-bi-with-a-new-office-365-trial.md). Muutoin Power BI -palvelu avautuu selaimessasi.
...
![Power BI Pro -kokeiluversion valintaikkuna](media/service-self-service-signup-for-power-bi/power-bi-start-trial.png)    

<sup>2</sup> Joissakin organisaatioissa oletusarvoinen Power BI -tilisi voi olla Power BI **Pro** -käyttöoikeus. Esimerkiksi jotkin Office 365 -versiot sisältävät esimerkiksi Power BI Pro -käyttöoikeuden. Jos haluat etsiä käyttöoikeutesi, katso [Mikä käyttöoikeus minulla on?](consumer/end-user-license.md)



## <a name="trial-expiration"></a>Kokeiluversion vanhentuminen

Kun maksuton yksittäisen käyttäjän Power BI Pro -kokeiluversiosi vanhenee, käyttöoikeutesi vaihtuu takaisin (ilmaiseksi) Power BI -käyttöoikeudeksi. Kokeilujaksoa ei voi jatkaa. Sinulla ei ole enää käyttöoikeutta ominaisuuksiin, joihin tarvitaan Power BI Pro -käyttöoikeus. Jos haluat lisätietoja, katso kohta [Ominaisuudet käyttöoikeustyypin mukaan](service-features-license-type.md).    

Jos Power BI (ilmainen) -käyttöoikeus riittää, sinun ei tarvitse tehdä mitään muuta. Jos haluat hyödyntää Power BI Pron ominaisuuksia, osta Pro-käyttöoikeus valitsemalla **Osta nyt** tai siirry [Power BI -hintasivulle](https://powerbi.microsoft.com/pricing).

![Power BI Pro -kokeiluversion valintaikkuna](media/service-self-service-signup-for-power-bi/power-bi-start-trial.png)      

Jos omatoiminen osto ei ole käytettävissä, pyydä järjestelmänvalvojaltasi neuvoja Power BI Pro -käyttöoikeuden ostamiseen.
