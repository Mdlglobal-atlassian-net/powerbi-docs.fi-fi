...
![](media/service-self-service-signup-for-power-bi/dashboard-report.png "Power BI -raporttinäkymä ja raportti")
...
### <a name="what-email-address-can-be-used-with-power-bi"></a>Mitä sähköpostiosoitteita Power BI:n kanssa voi käyttää?
...
> [!NOTE]
> Voit rekisteröityä Power BI:hin .gov- tai .mil-osoitteilla. Lisätietoa saat artikkelista [Rekisteröi Yhdysvaltain valtionhallinnon organisaatio Power BI -palveluun](https://docs.microsoft.com/power-bi/service-govus-signup).
>

> [!NOTE]
> Kun olet rekisteröitynyt, voit [kutsua vieraskäyttäjiä](https://docs.microsoft.com/azure/active-directory/active-directory-b2b-what-is-azure-ad-b2b) nähdäksesi Power BI -vuokraajan sisältöä millä tahansa sähköpostiosoitteella, henkilökohtaiset tilit mukaan lukien.
>

## <a name="which-one-do-you-need"></a>Kumpaa tarvitset?
...
## <a name="signing-up-for-power-bi-free-as-an-individual"></a>Rekisteröityminen Power BI:hin (ilmainen) yksityishenkilönä
...
### <a name="what-if-youre-already-part-of-an-existing-organization"></a>Mitä, jos olet jo olemassa olevan organisaation osa?
...
## <a name="what-if-you-want-the-full-power-bi-pro"></a>Entä jos haluat täyden Power BI Pro -version?
