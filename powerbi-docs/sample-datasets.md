...
Mutta ennen kuin aloitamme, lue läpi nämä oikeudelliset ohjeet mallien käyttämisestä. Sen jälkeen esittelemme sinulle mallit ja niiden käyttötavat.   

## <a name="usage-guidelines-for-the-power-bi-sample-excel-workbooks"></a>Ohjeet Power BI:n Excel-työkirjamallien käytöstä
Lue seuraavat tiedot, ennen kuin käytät Power BI:n malleja.
...
## <a name="how-to-get-the-samples"></a>Mallien hankkiminen
Kuten edellä jo kerrottiin, mallit ovat saatavilla useissa muodoissa: sisältöpaketteina, Excel-työkirjoina ja .pbix-tiedostoina. Seuraavassa kerromme, miten kutakin niistä käytetään – sisältöpaketeista aloittaen.

## <a name="the-power-bi-samples-as-content-packs"></a>Power BI ‑mallit sisältöpaketteina
Sisältöpaketit ovat ainoa mallien muoto, joka on saatavilla suoraan Power BI:stä – sinun ei tarvitse poistua Power BI:stä saadaksesi ne. Sisältöpaketti on käytännössä yhdestä tai useammasta koontinäytöstä, tietojoukosta ja raportista koostuva paketti, jonka joku kokoaa Power BI -palvelussa käytettäväksi. Sisältöpaketin luoja voi jakaa paketin työtovereilleen. Jokainen Power BI ‑mallisisältöpaketti sisältää tietojoukon, raportin ja koontinäytön.  Sisältöpaketteja eivät ole käytettävissä Power BI Desktopissa. Lisätietoja sisältöpaketeista saat lukemalla artikkelin [Johdatus Power BI:n sisältöpaketteihin](service-organizational-content-pack-introduction.md).

### <a name="get-and-open-a-sample-content-pack-in-power-bi-service"></a>Mallisisältöpaketin noutaminen ja avaaminen Power BI -palvelussa
...
* Kun avaat mallityökirjan Excelissä ensimmäistä kertaa, esiin saattaa tulla kaksi varoitusta. Ensimmäinen ilmoittaa, että työkirjassa käytössä suojattu näkymä. Valitse **Ota muokkaaminen käyttöön**. Toinen saattaa sanoa, että työkirjassa on ulkoisia tietoyhteyksiä. Valitse **Ota sisältö käyttöön**.
* Kussakin työkirjassa on useita laskentataulukoita. Koska kussakin näistä Excel-malleista on vähintään yksi Power View ‑taulukko, jossa on visualisointeja, saat tietojoukon **sekä** raportin tuodessasi Excel-tiedoston Power BI:hin.

   Sinun saattaa olla tarpeen [ottaa käyttöön Power View ‑apuohjelma](https://support.office.com/article/Create-a-Power-View-sheet-in-Excel-2013-B23D768D-7586-47FE-97BD-89B80967A405#__toc328591957).
* Missä siis varsinaiset tiedot ovat? Ne ovat PowerPivot-tietomallissa. Jos haluat nähdä tiedot, valitse **PowerPivot**-välilehdeltä **Hallitse tietomallia**.
...
## <a name="the-power-bi-samples-as-pbix-files"></a>Power BI ‑mallit .pbix-tiedostoina
...
4. Avaa .pbix-tiedosto Desktopissa valitsemalla tiedosto.
