...
### <a name="margins"></a>Reunukset
 ...
 Fyysisen sivun aluetta, joka jää jäljelle, kun tila on varattu reunuksille, sarakkeiden välistykselle sekä sivun ylä- ja alatunnisteille, kutsutaan *käytettävissä olevakse sivualueeksi*. Reunuksia käytetään vain, kun raportteja hahmonnetaan ja tulostetaan kiinteän sivunvaihdon hahmontimen muodossa. Seuraavassa kuvassa näkyy fyysisen sivun reunus ja käytettävissä oleva sivualue.  
