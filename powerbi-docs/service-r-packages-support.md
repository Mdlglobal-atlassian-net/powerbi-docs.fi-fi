...
## <a name="r-packages-that-are-supported-in-power-bi"></a>R-paketit, joita tuetaan Power BI:ssä
...
|tietojoukot| 3.4.1| NA|
|päivämäärä| 1.2-37| https://cran.r-project.org/web/packages/date/index.html |
...
|grafiikka| 3.4.1| NA|
|grafiikka| grDevices| party (>= 1.1-0)|
|grafiikka| CRAN| NA|
|grDevices| 3.4.1| NA|
...
|gridExtra (>= 2.0.0)| grafiikka| reshape2|
...
|raportit| 0.1.4| https://cran.r-project.org/web/packages/reports/index.html |
...
|rngtools (>= 1.2.3)| cluster| grafiikka|
...
|puukartta| 2.4-2| https://cran.r-project.org/web/packages/treemap/index.html |
...
## <a name="r-scripts-that-are-not-supported-in-power-bi"></a>R-komentosarjat, joita ei tueta Power BI:ssä
