...
* Mukautettujen siirtymistoimintojen suunnitteleminen [Power BI -sovelluksille](../collaborate-share/service-create-distribute-apps.md) yleisesti saatavilla.
...
* [Multi-Geo-premium-kapasiteettien](../admin/service-admin-premium-multi-geo.md) suorituskykyparannukset.
* [Luku/kirjoitus-XMLA-päätepisteiden](../admin/service-premium-connect-tools.md) julkinen esikatselu Power BI Premiumissa.
...
* Raporttien upottaminen uuden [Power BI -välilehden](../collaborate-share/service-embed-report-microsoft-teams.md) avulla Microsoft Teamsissa.
* Power BI Pro -käyttäjiä tukeva [lisäävä päivitys](../admin/service-premium-incremental-refresh.md) yleisesti käytettävissä.
* Sähköpostitilausten tuki ulkoisille sähkö postiosoitteille.
* Power BI Premiumin [Bring Your Own Key (BYOK)](../admin/service-encryption-byok.md) -ominaisuus yleisesti käytettävissä.

### <a name="january-2020"></a>Tammikuu 2020
* Uudet ja parannetut [käyttömittarit](../collaborate-share/service-usage-metrics.md) Power BI:n työtilakokemuksessa.
...
* Julkinen esikatselu [Power BI Premiumin suuret mallit] (../admin/service-premium-large-models.md].
...
* Yleinen saatavuus [automaattianalyysipalvelut](../transform-model/service-machine-learning-automated
* Power BI -tietojen historianäkymän julkinen esikatselu.

### <a name="september-2019"></a>Syyskuu 2019
* Päivitykset [mallisovellusten](../connect-data/service-template-apps-overview.md) yhteyden määrittämiseen.
...
* Power BI -[koosteiden](../transform-model/desktop-aggregations.md) yleinen saatavuus.
...
* [Jaettujen ja sertifioitujen tietojoukkojen](../connect-data/service-datasets-across-workspaces.md) julkinen esikatselu.
* [Premium-kapasiteettimittarisovelluksessa](../admin/service-admin-premium-monitor-capacity.md) käytettävissä olevat AI-mittarit.
* [Power BI -mallisovellusten](../connect-data/service-template-apps-overview.md) yleinen saatavuus.
* [Sivutettujen raporttien](../paginated-reports/paginated-reports-report-builder-power-bi.md) yleinen saatavuus Power BI:ssä.
* Bring Your Own Keyn ([BYOK](../admin/service-encryption-byok.md)) julkinen esikatselu Power BI Premiumissa.
* Katselija-rooli [uudelle työtilakokemukselle](../collaborate-share/service-new-workspaces.md).

### <a name="may-2019"></a>Toukokuu 2019
* [Mukautettu siirtyminen](../collaborate-share/service-create-distribute-apps.md) Power BI -sovelluksissa.
...
* Power BI:n [tietovoiden](../transform-model/service-dataflows-overview.md) yleinen saatavuus.
...
* [Kyselyn tallentaminen välimuistiin](../connect-data/power-bi-query-caching.md) saatavana Power BI Premiumissa.
...
* [Sähköpostitilaukset tarvittaessa](../collaborate-share/service-publish-to-web.md).
...
* Tietojen periytymisen käyttökokemus [tietovuoille](../transform-model/service-dataflows-overview.md).
* Sertifioidut Power BI -visualisoinnit -asetus hallintaportaalissa.

### <a name="january-2019"></a>Tammikuu 2019
* [Turvallisten Power BI -raporttien upottaminen](../collaborate-share/service-embed-report-spo.md) sisäisiin portaaleihin tai verkkosivustoihin.
* Päivittää [tietovoiden](../transform-model/service-dataflows-overview.md) editoriin uudet liittimet sekä alkuperäisten SQL-kyselyjen ja Power Query Online -muunnosten tuen.
...
* Power BI -tietovoiden esikatselu ja Azure Data Lake Storage Gen2 -integrointi [tietovoihin](../transform-model/service-dataflows-overview.md).
* Power BI -ratkaisumalleista tuli avoin lähdekoodi.

### <a name="november-2018"></a>Marraskuu 2018
* Power BI -tietojen valmistelu saatavissa [tietovoiden](../transform-model/service-dataflows-overview.md) julkisessa esikatselussa.
...
* Power BI [-raportin URL-suodattimen](../collaborate-share/service-url-filters.md) parannukset
...
* [Multi-Geo-tuki](../admin/service-admin-premium-multi-geo.md) Power BI Premiumille.
...
* [Teeman koontinäytöt](../create-reports/service-dashboard-themes.md) Power BI -palvelussa.
* [Lisäävä päivitys](../admin/service-premium-incremental-refresh.md) Premiumin avulla.
* Pyydä käyttöoikeustyönkulkua [Power BI -sovelluksille](../collaborate-share/service-create-distribute-apps.md).
* Get Data -päivitykset, jotta käyttäjien on helpompi löytää [Power BI -sovellukset](../collaborate-share/service-create-distribute-apps.md).
...
* Power BI -palvelun [valvontalokit](../admin/service-admin-auditing.md) ovat oletuksena käytössä Office 365:n vuokraajille.
...
* Asenna [Power BI -sovellukset](../collaborate-share/service-create-distribute-apps.md) automaattisesti käyttäjille.
...
*    Valikoiva sisällön julkaisu [Power BI -sovellusten](../collaborate-share/service-create-distribute-apps.md) avulla.
...
* Parannettu [käyttötietojen](../collaborate-share/service-usage-metrics.md) lataussuorituskyky.
...
* Aloita verkkopalvelujen [Power BI -palvelun](../connect-data/service-connect-to-services.md) sovellusten käyttö.
...
* Mittaa vaikutustasi ja paranna sitä [koontinäytön ja raporttien luojien käyttötiedoilla](../collaborate-share/service-usage-metrics.md).
...
* [Sisältöpaketin tuki rivitason suojaukselle](../admin/service-admin-rls.md) (esikatselu): jos rivitason suojaus on määritetty koontinäytöille ja raporteille, jotka jaetaan sisältöpaketin osana, suojaussääntöjä noudatetaan kyseisten sisältöpakettien osalta.

***Koontinäytöt***

* [Vimeo-videon ruutu](../create-reports/service-dashboard-add-widget.md):  lisää koontinäytöstä ruutu, joka sisältää upotetun Vimeo-soittimen.

***Analysoi Excelissä***

* [Analysoi Excelissä](../collaborate-share/service-analyze-in-excel.md) kaikkien käyttäjien saatavilla: mahdollisuus käyttää Power BI -tietomalleja Excelissä on laajennettu kaikille käyttäjille heille määritetystä käyttöoikeudesta riippumatta.
...
* Jaa organisaation ulkopuolisten käyttäjien kanssa
...
Power BI -tiimi on ollut kiireinen loman aikana. Saat kaikki tiedot [Power BI -tiimin blogista](https://powerbi.microsoft.com/blog/power-bi-service-update-0106/)
...
Saat kaikki tiedot [Power BI -tiimin blogista](https://powerbi.microsoft.com/blog/power-bi-service-update-0106/)

## <a name="2015"></a>2015
**16. joulukuuta 2015**

Paljon päivityksiä tällä viikolla, useimmat koskevat Power BI Desktopia mutta monia merkittäviä päivityksiä myös raporttien tuottamiseen ja visualisointeihin. [Power BI -tiimin blogi](https://powerbi.microsoft.com/blog/more-power-bi-feature-updates-power-bi-desktop-december-update-and-new-power-bi-service-features/) sisältää täydet kuvaukset ja jopa päivityksiä kuvaavan videon.   
...
Saat kaikki tiedot mukaan lukien videon, jossa esitellään monet näistä päivityksistä, [Power BI -blogista](https://powerbi.microsoft.com/blog/more-power-bi-feature-updates-power-bi-desktop-december-update-and-new-power-bi-service-features/).
...
* Muuta raportin visualisointien välisiä vuorovaikutuksia
  ...
  Saat kaikki tiedot [Power BI -blogista](https://powerbi.microsoft.com/blog/power-bi-weekly-service-update-1210/).

**8. joulukuuta 2015**

* [QR-koodit Power BI:ssä](https://powerbi.microsoft.com/blog/bridge-the-gap-between-your-physical-world-and-your-bi-using-qr-codes/)

**3. joulukuuta 2015**

* Löydä automaattisesti trendejä ja tunnista kuvioita tietojoukossa nopeiden merkityksellisten tietojen avulla: [video](https://powerbi.microsoft.com/blog/power-bi-updates-from-browser-to-desktop-and-new-automated-insights-mf/) tai [artikkeli](../consumer/end-user-insights.md)
* [Visualisoi VMob-tietoja Power BI:ssä](https://powerbi.microsoft.com/blog/visualize-your-vmob-data-in-power-bi/)
* [Power BI -yritysyhdyskäytävän esiversio](https://powerbi.microsoft.com/blog/announcing-preview-of-power-bi-gateway-for-enterprise-deployments/)
* Uuden sisältöpaketin esittely: [hakuanalyysi Bingistä Power BI -koontinäytöissä](https://powerbi.microsoft.com/blog/search-analytics-from-bing-on-your-power-bi-dashboards/)
* Uusia kehittäjille tarkoitettuja parannuksia: [kaksi uutta ohjelmointirajapintaa ja helpompi sovelluksen rekisteröinti](https://powerbi.microsoft.com/blog/power-bi-for-developers-reports-api-and-a-simple-app-registration-experience)
...
Saat kaikki tiedot [Power BI -blogista](https://powerbi.microsoft.com/blog/power-bi-weekly-service-update-1124/)
...
Saat kaikki tiedot [Power BI -blogista](https://powerbi.microsoft.com/blog/power-bi-weekly-service-update-1117/)
...
Saat kaikki tiedot [Power BI -blogista](https://powerbi.microsoft.com/blog/power-bi-weekly-service-update-1110/)
...
Saat kaikki tiedot [Power BI -blogista](https://powerbi.microsoft.com/blog/power-bi-weekly-service-update-1103/)
...
Saat kaikki tiedot [Power BI -blogista](https://powerbi.microsoft.com/blog/power-bi-weekly-service-update-1027/)
...
Saat kaikki tiedot [Power BI -blogista](https://powerbi.microsoft.com/blog/power-bi-weekly-service-update-1020/)
...
Saat lisätietoja [blogista](https://powerbi.microsoft.com/blog/power-bi-service-weekly-update-10-06/) ja [verkkodokumentaatiosta](service-get-started.md).
...
* Azure-valvontalokien avulla voit tarkastella Azure-tilauksesi hallintatason toimintalokeja. Power BI:n Azure-valvontalokit-sisältöpaketin avulla voit helposti analysoida ja visualisoida näiden lokien sisältämää suurta tietomäärää. Sisältöpaketin avulla voit muodostaa yhteyden tietoihisi ja alkaa tutkimaan merkityksellisiä tietoja valmiin koontinäytön ja raporttien avulla. Saat lisätietoja [blogista](https://powerbi.microsoft.com/blog/monitor-azure-audit-logs-with-power-bi/) ja [verkkodokumentaatiosta](../connect-data/service-connect-to-services.md).

[Saat lisätietoja blogista](https://powerbi.microsoft.com/blog/power-bi-weekly-service-update-0929/).

**22. syyskuuta 2015**

* Mukauta koontinäyttöjäsi joustavammin ruutujen lisäkokovalikoiman 1 x 1–5 x 5 avulla.
* Voit nyt [jakaa koontinäytön (ja lopettaa sen jakamisen) ryhmätilastasi](../collaborate-share/service-collaborate-power-bi-workspace.md) samoin kuin tekisit omassa tilassasi. Kun työtoverit hyväksyvät jakamiskutsusi, jaettu koontinäyttö (ja siihen liittyvät raportit) lisätään omaan tilaansa vain luku -oikeuksilla.
* Power BI:hin on lisätty viisi muuta [alaan liittyvää mallia](../create-reports/sample-datasets.md): asiakkaan tuottavuus, henkilöstöhallinto, mahdollisuusanalyysi, hankinta-analyysi ja myynti- ja markkinointimalli.
* Stripe on ennakkomaksuympäristö verkkoyrityksille. Tuhannet yritykset kasvuyrityksistä Fortune 500 -yrityksiin käyttävät Stripea maksujen hyväksymiseen yli 130 valuutassa keneltä tahansa maailmassa. Kun yhdistät Power BI:n aiemmin luotuun Stripe-tiliisi, voit [Power BI:n Stripe-sisältöpaketin avulla seurata, tarkastella ja visualisoida Stripe-toimintaasi](../connect-data/service-connect-to-services.md).

[Saat lisätietoja blogista](https://powerbi.microsoft.com/blog/power-bi-weekly-service-update-0922/).
...
* tyGraphia varten on luotu uusi sisältöpaketti, jonka avulla voit helposti saada tarkempia merkityksellisiä tietoja Yammer-tiedoistasi. Sisältöpaketti sisältää koontinäytön, raportteja ja valitun tietojoukon, joiden avulla voidaan tutkia ja tarjota merkityksellisiä tietoja, kuten aktiivisen osallistumisen mittari (MAE-pisteet), ja sisällönkulutustietoja, kuten tiedoston katselut ja tiedoston lataukset. Saat lisätietoja [blogista](https://powerbi.microsoft.com/blog/analyze-and-monitor-your-tygraph-data-with-power-bi/) ja [ohjeaiheesta](../connect-data/service-connect-to-services.md).

**1. syyskuuta 2015**

* Webtrends auttaa yrityksiä hyödyntämään asiakastietojaan digitaalisen markkinoinnin onnistumisen varmistamiseksi. Käyttäjät voivat tarkkailla, analysoida ja toimittaa merkityksellisiä tietoja kävijöiden toiminnasta verkossa, yhteisöpalveluissa ja mobiili- ja SharePoint-kanavissa. [Webtrends-sisältöpaketin](https://powerbi.microsoft.com/blog/visualize-and-explore-your-webtrends-data-in-power-bi/) julkaisun myötä käyttäjillä on nyt mahdollisuus käyttää Power BI:tä Webtrends-analytiikkatietojen valvontaan, analysointiin ja visualisointiin. Power BI:n Webtrends-sisältöpaketin [ohjesivulla](../connect-data/service-connect-to-services.md) on tarkempia tietoja.
...
* Azure Mobile Engagement on sovellusanalytiikkapalvelu, jonka avulla kehittäjät voivat seurata sovelluksensa suorituskykyä ja parantaa siten sovelluksessa pysymistä ja sovelluksen käyttöä. Käyttämällä [Power BI:n Azure Mobile Engagement -sisältöpakettia](https://powerbi.microsoft.com/blog/monitor-and-analyze-your-azure-mobile-engagement-data-in-power-bi/) voit muodostaa nopeasti yhteyden valmiiseen koontinäyttöön, raporttijoukkoon ja valittuun tietojoukkoon ja saada heti merkityksellisiä tietoja siitä, miten hyvin sovelluksesi toimii. Saat lisätietoja [Power BI -ohjesivun Azure Mobile Engagement -sisältöpaketista](../connect-data/service-connect-to-services.md).

**11. elokuuta 2015**

* Mandrill on MailChimpin kehittämä sähköposti-infrastruktuuripalvelu, jonka avulla voit analysoida sähköpostikampanjoita monenlaisista tiedoista. [Power BI:n Mandrill-sisältöpaketin](https://powerbi.microsoft.com/blog/explore-and-analyze-your-mandrill-data-in-power-bi/) avulla voit muodostaa nopeasti yhteyden Mandrill-dataasi ja saada heti uutiskirjettä tai markkinointikampanjaa koskevia merkityksellisiä tietoja. Saat lisätietoja käytön aloittamisesta [Power BI -ohjesivun Mandrill-sisältöpaketista](../connect-data/service-connect-to-services.md).

**4. elokuuta 2015**

* Power BI tarjoaa nyt [Circuit ID:n](https://powerbi.microsoft.com/blog/circuit-id-data-with-power-bi/) käyttäjille mahdollisuuden seurata ja valvoa kaikkia Circuit ID -pilviviestintäpalvelujaan, jotta he voivat tehdä oikeita liiketoimintapäätöksiä. Saat lisätietoja käytön aloittamisesta [Power BI -ohjesivun](../connect-data/service-connect-to-services.md) Circuit ID -sisältöpaketista.
* Tänään on julkaistu parannus Jaa koontinäyttö -ominaisuuteen, jonka myötä sen käyttö on entistäkin helpompaa.  Jos organisaatiosi käyttää Office 365:n sähköpostia, voit nyt [jakaa sähköpostin jakeluryhmään](https://powerbi.microsoft.com/blog/easier-dashboard-sharing-with-distribution-groups/) samaan tapaan kuin lähettäisit sähköpostiviestin Outlookissa.  Kirjoita vain jakeluryhmän osoite ja valitse Jaa.  Kaikki jakeluryhmän jäsenet saavat sähköpostikutsun koontinäytön tarkastelemiseen.

**28. heinäkuuta 2015**

* Tämän viikon Power BI -päivitys tarjoaa tietokannan suorituskyvyn seurannan [SQL Sentry -sisältöpaketin](https://powerbi.microsoft.com/blog/monitoring-your-sql-sentry-data-with-power-bi/) avulla. Tämä sisältöpaketti sisältää koontinäytön ja raportteja, joiden avulla voit valvoa SQL Server -käyttöönottoja, joita seuraat käyttämällä SQL Sentry -pilvipalvelua. Saat lisätietoja käytön aloittamisesta [Power BI -ohjesivun](../connect-data/service-connect-to-services.md) SQL Sentry -sisältöpaketista.
...
* [Power BI -ryhmät](../collaborate-share/service-create-distribute-apps.md): Ryhmät ovat tehokas Office 365 -ryhmiin perustuva yhteistyötoiminto.
* [Organisaation sisältöpaketit](../collaborate-share/service-organizational-content-pack-introduction.md): Power BI tekee koontinäyttöjen ja raporttien luomisesta erittäin yksinkertaista, ja nyt käyttäjät voivat julkaista tätä sisältöä organisaation sisältövalikoimassa.
* [Tuo kokonaisia Excel-tiedostoja](../connect-data/service-excel-workbook-files.md): voit tuoda minkä tahansa OneDrive for Businessiin tallennetun Excel-työkirjan Power BI:hin ja näyttää koko työkirjan samalla tavalla kuin Excel Onlinessa.
* [Tuo CSV-tiedostoja](../connect-data/service-get-data-from-files.md): samalla tavalla kuin Excel- tai Power BI Desktop -tiedosto, myös CSV-tiedosto voi olla Power BI -koontinäyttöjesi ja -raporttiesi tietojoukko.
...
* Tämän viikon Power BI -päivitys tarjoaa nyt työnimikkeen seurannan [Visual Studio Online -sisältöpaketin](https://powerbi.microsoft.com/blog/monitoring-your-visual-studio-online-work-items-with-power-bi/) avulla. Päivitys sisältää uuden koontinäytön, raportin ja päivitetyn tietojoukon, joka tarjoaa merkityksellisiä tietoja työnimikkeistäsi ja lisäksi tärkeitä tietoja Git-säilöstä, noutopyynnöistä ja versionhallintasisällöstä, jotka sisältyivät ensimmäiseen versioon. Saat lisätietoja käytön aloittamisesta [Power BI -ohjesivun Visual Studio Online -sisältöpaketista](../connect-data/service-connect-to-quickbooks-online.md).

**14. heinäkuuta 2015**

* Acumatica Cloud ERP tarjoaa joukon täysin integroituja liiketoiminnan hallintasovelluksia, kuten Taloustiedot, Jakelu, CRM ja Projektikirjanpito, tehokkaassa ja joustavassa käyttöympäristössä. [Power BI:n Acumatica-sisältöpaketin](https://powerbi.microsoft.com/blog/analyze-and-explore-your-acumatica-cloud-erp-data-with-power-bi/) avulla voit muodostaa yhteyden nopeasti ja saada heti merkityksellisiä tietoja mahdollisuustiedoistasi. Sisältöpakettiin kuuluu valmis koontinäyttö, joukko raportteja ja valittu tietojoukko, joiden avulla voit tutkia ja tarjota lisätietoja, kuten kaikki voitetut mahdollisuudet päivämäärän mukaan. Lue lisätietoja [täältä](../connect-data/service-connect-to-services.md). 
* [Azure HDInsight](https://powerbi.microsoft.com/blog/visualize-big-data-with-power-bi-and-spark-for-azure-hdinsight/) tarjoaa nyt täysin hallitun Spark-palvelun. Tämä ominaisuus mahdollistaa skenaariot, kuten toistuvan koneoppimisen ja vuorovaikutteisen tietoanalyysin. Power BI:n avulla voit muodostaa suoraan yhteyden HDInsight Sparkiin, joka mahdollistaa tietojen yksinkertaisen ja reaaliaikaisen tarkastelemisen. Saat lisätietoja [ohjedokumentaatiosta](../connect-data/power-bi-data-sources.md).
* [Office 365:n siirtymisen ja sovelluksen käynnistystoiminnon integrointi](https://powerbi.microsoft.com/blog/new-capabilities-added-to-power-bi#launcher). Voit nyt siirtyä kaikkiin Office 365 -sovelluksiisi yhdellä napsautuksella.
* [Mukautetun URL-osoitteen määrittäminen](https://powerbi.microsoft.com/blog/new-capabilities-added-to-power-bi#url): osoite, johon käyttäjät siirtyvät ruutua napsautettuaan. Sinulla on nyt mahdollisuus ohjata tarkasti, minne käyttäjät siirtyvät: tiettyyn raporttiin, toiseen koontinäyttöön, SSRS-raporttiin tai ulkoiseen sivustoon. 
* Power BI:ssä käyttämäsi [tallennustilan näkyvyys ja hallinta](https://powerbi.microsoft.com/blog/new-capabilities-added-to-power-bi#storage)
* [Q&A:ssa näkyvän visualisoinnin ja kenttien määrittäminen](https://powerbi.microsoft.com/blog/new-capabilities-added-to-power-bi#visual)

**7. heinäkuuta 2015**

* Yksi odotetuimmista ja toivotuimmista ominaisuuksista on nyt käytettävissä Power BI:ssä. Voit tästä päivästä alkaen [päivittää tietojoukkoja](https://powerbi.microsoft.com/blog/refresh-for-on-premises-sources-is-here/) Power BI:ssä muodostamalla yhteyden paikallisiin lähteisiin, kuten SQL Serveriin. Voit päivittää tietojoukon, joka on luotu Power BI Designer -tiedostosta tai Excel-työkirjasta työkirjaan Power Queryn tai Power Pivotin avulla tuotujen tietojen kanssa. 

**30. kesäkuuta 2015**

* Nyt on julkaistu uusi [Power BI:n UserVoice-sisältöpaketti](https://powerbi.microsoft.com/blog/monitor-and-visualize-your-uservoice-data-with-power-bi/), jonka avulla voit seurata ja visualisoida UserVoice-dataasi ja saada niistä heti merkityksellisiä tietoja käyttövalmiin koontinäytön ja raportin avulla.

**23. kesäkuuta 2015**

* Power BI Desktop -tiedostoja voidaan [päivittää](https://powerbi.microsoft.com/blog/announcing-refresh-support-for-power-bi-designer-files-in-the-power-bi-service/) (ajoitettu päivitys ja päivitä nyt), kun niitä ladataan Power BI -palveluun.
* Nyt julkaistaan Power BI:n suurin visuaalinen muutos joulukuun jälkeen: selkeämpi ja yksinkertaisempi [Nouda tiedot](https://powerbi.microsoft.com/blog/the-new-get-data-experience/) -käyttökokemus.  Kun valitset Nouda tiedot, näet nyt yhden näytön, jossa on valittavana joukko luokkia. Näin löydät sinulle tärkeimmän sisällön entistä helpommin.
* [Azure SQL Data Warehouse](https://powerbi.microsoft.com/blog/exploring-azure-sql-data-warehouse-with-power-bi/) tarjoaa joustavan skaalauksen ja suuren rinnakkaiskäsittelyn. Tänään julkaistun rajoitetun julkisen esiversion myötä Power BI mahdollistaa nyt yhteyden muodostamisen suoraan Azure SQL Data Warehouseen tallennettuihin tietoihin, mikä tarjoaa yksinkertaisen ja dynaamisen tarkastelun. Luotuasi yhteyden tietovarastoon kyselyt luodaan reaaliaikaisesti ja lähetetään takaisin lähteeseen, kun tarkastelet tietoja. Tämä poistaa tarpeen luoda ja ladata mukautettu tietomalli ja mahdollistaa tietojen vuorovaikutteisen tarkastelemisen.

**16. kesäkuuta 2015**

* SweetIQ:n avulla voit helposti seurata paikallisia tietoja tarjoamalla sijainti- ja tarkastustietoja paikallisesta hakuekosysteemistä. Power BI:n avulla voit analysoida ja valvoa kyseisiä tietoja tarjoamalla SweetIQ-tiedoista luotua [valmista sisältöä](https://powerbi.microsoft.com/blog/analyze-and-monitor-your-sweetiq-data-with-power-bi/). Saat lisätietoja käytön aloittamisesta [Power BI -ohjesivun](../connect-data/service-connect-to-services.md) SweetIQ-sisältöpaketista.

**2. kesäkuuta 2015**

* Nyt sovelluksia koskevien tärkeiden tilastotietojen seuraaminen on helppoa Power BI:n ja [appFigures-sisältöpaketin](https://powerbi.microsoft.com/blog/explore-and-analyze-your-appfigures-data-with-power-bi/) avulla. Saat lisätietoja yhteyden muodostamisesta ja käytön aloittamisesta Power BI:n appFigures-sisältöpaketin [dokumentaatiosta](../connect-data/service-connect-to-services.md).

**28. toukokuuta 2015**

* Saat nopeita merkityksellisiä tietoja QuickBooks Online -tilisi tiedoista käyttämällä [sisältöpakettia](https://powerbi.microsoft.com/blog/get-quick-insights-into-your-quickbooks-online-account-data). Saat lisätietoja yhteyden muodostamisesta ja käytön aloittamisesta Power BI:n QuickBooks Online -sisältöpaketin [dokumentaatiosta](../connect-data/service-connect-to-quickbooks-online.md).

**13. toukokuuta 2015**

* Voit muodostaa yhteyden suoraan **Azure SQL -tietokantaan** tallennettuihin tietoihin. Kyselyjä luodaan dynaamisesti ja lähetetään lähteeseen, jolloin voit luoda vuorovaikutteisia raportteja suoraan tietokannan kautta. Saat lisätietoja [blogimerkinnästä](https://powerbi.microsoft.com/blog/using-power-bi-to-visualize-and-explore-azure-sql-databases/) ja [dokumentaatiosta](../connect-data/service-azure-sql-database-with-direct-connect.md).
...
* Power BI on nyt saatavilla **44 kielellä**. Koko luettelo on [blogissa](https://powerbi.microsoft.com/blog/power-bi-preview-now-available-in-your-language/).

**23. huhtikuuta 2015**

* Voit nyt visualisoida ja tutkia **Microsoft Dynamics Marketing** -tietojasi uuden sisältöpaketin avulla. Lisätietoja saat lukemalla [blogikirjoituksemme](https://powerbi.microsoft.com/blog/monitor-and-explore-your-microsoft-dynamics-marketing-data-with-power-bi/).

**15. huhtikuuta 2015**

* Voit nyt visualisoida ja tutkia **Google Analytics** -tietojasi uuden sisältöpaketin avulla. Google Analytics -sisältöpaketti sisältää koontinäytön, raportin ja tietojoukon, joiden avulla saat merkityksellisiä tietoja sivustosi käytöstä viimeisten 6 kuukauden aikana. Voit lukea [blogikirjoituksen](https://powerbi.microsoft.com/blog/visualize-and-explore-your-google-analytics-data-with-power-bi/).
