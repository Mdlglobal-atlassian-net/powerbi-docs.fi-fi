...
ms.locfileid: "73880718"
---
# <a name="interacting-with-arcgis-maps-in-power-bi"></a>ArcGIS-karttojen käsittely Power BI:ssä
Tämä ohjeaihe on kirjoitettu sellaisen henkilön näkökulmasta, joka käyttää ArcGIS-karttaa Power BI -palvelussa, Desktopissa tai mobiililaitteessa. Kun ArcGIS-kartan tehnyt henkilö jakaa kartan sinulle, voit toimia kartan kanssa monin eri tavoin.  Jos haluat lisätietoa ArcGIS-karttojen luomisesta, katso [opetusohjelma Esrin ArcGIS-kartoista](../visuals/power-bi-visualization-arcgis.md).
...
![ArcGIS-kartta, jossa näkyy Yhdysvallat sekä kuplia, nastoja ja ajoaika](media/power-bi-visualizations-arcgis/power-bi-arcgis-esri-new.png)
...
![Näyttökuva kaikista kolmesta työkalusta](media/power-bi-visualizations-arcgis/power-bi-esri-selection-tools2.png)

![näyttökuva valitse yksi -työkalusta](media/power-bi-visualizations-arcgis/power-bi-esri-selection-single2.png) Valitse yksittäisiä arvopisteitä.

![valitse useita -työkalu](media/power-bi-visualizations-arcgis/power-bi-esri-selection-marquee2.png) Piirrä suorakulmio kartalle ja valitse siihen sisältyvät arvopisteet. CTRL-näppäimen avulla voit valita useita suorakulmioita.

![kolmas työkalu reunoja varten](media/power-bi-visualizations-arcgis/power-bi-esri-selection-reference-layer2.png) Voit käyttää rajauksia tai monikulmioita viittauskerroksissa ja valita siten sisäpuolelle jäävät arvopisteet.

<br/>

## <a name="interacting-with-an-arcgis-map"></a>ArcGIS-karttojen käsittely
Käytettävissäsi olevat ominaisuudet määräytyvät sen mukaan, oletko kartan *luoja* (alkuperäinen tekijä) vai *kuluttaja* (jolle ArcGIS-kartta on jaettu). Jos käsittelet ArcGIS-karttaa kuluttajana (kutsutaan myös [lukunäkymäksi](../consumer/end-user-reading-view.md)), käytettävissäsi ovat seuraavat toiminnot.
...
* Jos haluat tutkia karttaa suodattimien avulla, laajenna **Suodattimet**-ruutu.   
    ![Suodattimet-ruutu](media/power-bi-visualizations-arcgis/power-bi-filter-newer.png)  
* Jos kartassa on viittauskerros, voit valita sijainteja, jolloin niiden tiedot näytetään työkaluvihjeessä. Seuraavassa kuvassa näkyy valittuna oleva Adamsin piirikunta ja kartan tekijän lisäämän viittauskerroksen mukaisesti kotitalouksien keskitulo.
    ...
    ![Adamsin piirikunnan työkaluvihje](media/power-bi-visualizations-arcgis/power-bi-reference-layer.png)  
    ...
    ![Baarin työkaluvihje alkuperäisessä työhaluvihjekaaviossa](media/power-bi-visualizations-arcgis/power-bi-tooltip-chart.png)
...
* Kun viet hiiren osoittimen pohjakarttaan merkittyjen symbolien kohdalle, näet työkaluvihjeen, joka antaa lisätietoja.     
  ![sijainnin työkaluvihje](media/power-bi-visualizations-arcgis/power-bi-arcgis-hover.png)
...
* Jos kartan luoja on lisännyt ArcGIS-karttaan infografiikkakerroksen, näet lisää tietoja kartan oikeassa yläkulmassa.  Esimerkiksi tässä tapauksessa kartan luoja on lisännyt merkinnän ”alle 14-vuotiaat lapset”.
    ...
    ![kartta, jossa on infograafikerros](media/power-bi-visualizations-arcgis/power-bi-demographics.png)
