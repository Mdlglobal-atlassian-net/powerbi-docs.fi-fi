...
## <a name="scheduled-refresh-failures"></a>Ajoitetun päivityksen virheistä
Jos ajoitettu päivitys epäonnistuu rivin neljä kertaa, Power BI poistaa käytöstä päivitys. Taustalla oleva ongelma ja ottaa ajoitetun päivityksen uudelleen.
