...
Katso lisätietoja Azuren automaattianalyysipalvelujen integroinnista Power BI:ssä artikkelista [Azuren Automaattianalyysipalveluiden Power BI -integrointi (esikatselu)](../transform-model/service-machine-learning-integration.md).
