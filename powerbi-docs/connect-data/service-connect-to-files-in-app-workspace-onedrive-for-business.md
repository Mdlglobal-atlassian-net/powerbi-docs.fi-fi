...
[Luotuasi Power BI:hin työtilan](../collaborate-share/service-create-distribute-apps.md) voit tallentaa Excel-, CSV- ja Power BI Desktop ‑tiedostosi OneDrive for Business ‑palveluun ja käyttää niitä sieltä Power BI ‑työtilassa. Voit jatkaa OneDriveen tallentamiesi tiedostojen päivittämistä. Päivitykset tulevat automaattisesti esiin myös kyseisiin tiedostoihin perustuvissa Power BI ‑raporteissa ja koontinäytöissä. 

> [!NOTE]
> Uusi työtilakokemus muuttaa Power BI -työtilojen ja Office 365:n ryhmien välistä suhdetta. Et luo automaattisesti Office 365 -ryhmää aina, kun luot uuden työtilan. Lue tietoja [uusien työtilojen luomisesta](../collaborate-share/service-create-the-new-workspaces.md)
...
> [!NOTE]
> Työtilat ovat käytettävissä vain [Power BI Pro:ssa](../fundamentals/service-features-license-type.md).
> 
...
* [Sovellusten ja työtilojen luominen Power BI:ssä](../collaborate-share/service-create-distribute-apps.md)
