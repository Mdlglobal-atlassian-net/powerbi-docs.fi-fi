...
**Organisaatio**: Jos sinulla ja muilla organisaatiosi käyttäjillä on Power BI Pro -tili, voitte luoda, jakaa ja käyttää sisältöpaketteja. Lisätietoja on kohdassa [Organisaation sisältöpakettien esittely](../collaborate-share/service-organizational-content-pack-introduction.md).
...
* **Tietojoukon kokorajoitus**: Power BI -palvelun jaettuihin kapasiteetteihin tallennettujen tietojoukkojen suurin sallittu koko on 1 Gt. Jos tarvitset suurempia tietojoukkoja, voit käyttää [Power BI Premiumia](../admin/service-premium-what-is.md).
