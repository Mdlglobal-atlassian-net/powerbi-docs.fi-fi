...
- [Power BI Desktop -asennus](../fundamentals/desktop-get-the-desktop.md) (valinnainen)
- [Power BI-peruskäsitteiden](../fundamentals/service-basic-concepts.md) tuntemus
- Käyttöoikeudet mallisovelluksen jakamiseen julkisesti (lisätietoja on Power BI [-hallintaportaalissa kohdassa Mallisovelluksen asetukset](../admin/service-admin-portal.md#template-apps-settings)
...
1. Valitse mallin työtilassa **Luo sovellus**.
    ...
    **Siirtyminen**
    ...
    Aktivoi **Uusi siirtymisen muodostin**, jossa voit määrittää sovelluksen siirtymisruudun (lisätietoja on tämän artikkelin kohdassa [Suunnittele siirtymistoiminnot](../collaborate-share/service-create-distribute-apps.md#design-the-navigation-experience)).
...
10. Kun olet valmis korottamaan sovelluksesi esituotantoon niin, että sen testausta voidaan jatkaa oman vuokraajasi ulkopuolella, palaa **Julkaisun hallinta** -ruutuun ja valitse **Korota sovellus**. 
    ...
    Jos et näe tätä asetusta, ota yhteyttä Power BI-järjestelmänvalvojaasi ja pyydä häntä myöntämään [mallisovellusten kehitysoikeudet](../admin/service-admin-portal.md#template-apps-settings) hallintaportaalissa.
