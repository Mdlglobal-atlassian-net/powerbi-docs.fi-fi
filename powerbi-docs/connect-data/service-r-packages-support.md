...
ms.locfileid: "83328147"
---
# <a name="create-visuals-by-using-r-packages-in-the-power-bi-service"></a>Visualisointien luominen R-paketeilla Power BI -palvelussa
...
**Power BI -palvelussa** tuetut R-paketit on esitelty seuraavassa osassa nimeltä **Tuetut paketit**. Jos haluat pyytää tukea R-paketille, jota ei löydy tästä luettelosta, voit lähetä pyyntösi [Power BI:n Ideas-ryhmälle](https://ideas.powerbi.com).
...
|sirkumfleksi|6.0-78|https://cran.r-project.org/web/packages/caret/index.html|
...
|tietojoukot|3.4.4|NA|
|päivämäärä|1.2-38|https://cran.r-project.org/web/packages/date/index.html|
...
|Kaava|1.2-2|https://cran.r-project.org/web/packages/Formula/index.html|
...
|Matriisi|1.2-12|https://cran.r-project.org/web/packages/Matrix/index.html|
...
|lumivalkoinen|0.4-2|https://cran.r-project.org/web/packages/snow/index.html|
