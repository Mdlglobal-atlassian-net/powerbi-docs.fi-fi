...
Tietoja voi nyt käyttää tekstianalyysissa, ja voimme käyttää asennepisteytystä ja avainlauseiden poimintaa asiakkaiden kommenttisarakkeessa.
...
* Aloita [omatoiminen tietojen valmistelu tietovoiden avulla](../transform-model/service-dataflows-overview.md)
...
* [Azuren automaattianalyysipalveluiden integroiminen Power BI:hin (esikatselu)](../transform-model/service-machine-learning-integration.md)
* [Kognitiiviset palvelut Power BI:ssä (esikatselu)](../transform-model/service-cognitive-services.md)