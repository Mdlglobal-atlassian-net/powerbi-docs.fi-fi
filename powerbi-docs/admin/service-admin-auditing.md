...
| Säilyttää valvontatiedot, vaikka vuokraaja siirrettäisiin eri Azure-alueelle. | Ei säilytä aktiviteettitietoja, kun vuokraaja siirretään eri Azure-alueelle. |
...
<sup>2</sup> PublishtoWebReport viittaa [Julkaise verkkoon](../collaborate-share/service-publish-to-web.md) ‑ominaisuuteen.
