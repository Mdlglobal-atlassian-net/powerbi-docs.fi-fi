...
![Visualisoinnin suodatinluettelo](media/power-bi-report-filter-preview/power-bi-filter-visual.png)
...
Lukutilassa voit visualisoinnin suodatuskuvaketta osoittamalla näyttää ponnahdusikkunan, joka sisältää kaikki visualisointiin vaikuttavat suodattimet, osittajat ja niin edelleen. Ponnahdusikkunan muotoilu on sama kuin Suodattimet-ruudun muotoilu. 
...
1. Oletusarvon mukaan raportin käyttäjät voivat nähdä Suodattimet-ruudun. Jos et halua heidän näkevän sitä, valitse silmäkuvake **Suodattimet**-ruudun vierestä.
    ...
    ![Power BI -suodattimen silmäkuvake](media/power-bi-report-filter-preview/power-bi-filter-eye.png)
...
Kun otat nämä asetukset käyttöön ja poistat ne käytöstä uudessa Suodattimet-ruudussa, näet muutokset raportissa. Piilotetut suodattimet eivät näy suodattimen ponnahdusikkunassa visualisointia varten.
...
![Järjestä uudelleen suodattimen lajittelujärjestys](media/power-bi-report-filter-preview/power-bi-filter-sort.gif)
...
## <a name="filters-pane-scaling"></a>Suodattimet-ruudun skaalaus

Uusi Suodattimet-ruutu skaalaa raporttisivun ja visualisointien avulla, joten raporttisivu ja Suodattimet-ruutu säilyvät suhteessa toisiinsa.
...
![Suodattimet-ruudun helppokäyttötoiminnot](media/power-bi-report-filter-preview/power-bi-filter-accessible.png)
...
![Nimeä suodatin uudelleen](media/power-bi-report-filter-preview/power-bi-filter-rename.png)
...
![Rajoita suodatintyypin muuttamista](media/power-bi-report-filter-preview/power-bi-filter-restrict-change.png)
