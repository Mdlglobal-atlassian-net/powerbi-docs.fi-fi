...
Lisätietoja päivityksen ajoittamisesta saat artikkelista [Ajoitetun päivityksen määrittäminen](../connect-data/refresh-scheduled-refresh.md), jossa kerrotaan Power BI -tietojoukkojen päivittämisestä. Tietovoiden päivitysasetukset toimivat samalla tavalla kuin Power BI -tietojoukkojen. 
