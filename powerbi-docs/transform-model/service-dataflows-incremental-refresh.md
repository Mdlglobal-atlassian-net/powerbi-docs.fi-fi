...
Lisäävän päivityksen käyttäminen Power BI -tietovoissa edellyttää, että työtila, jossa tietovuo sijaitsee, on [Premium-kapasiteetissa](../admin/service-premium-what-is.md), ja tietovuossa käsitellyllä tietolähteellä on oltava *päivämäärä/aika*-kenttä, jonka mukaan lisäävä päivitys voidaan suodattaa. 
...
Lisätietoja lisäävästä päivityksestä on artikkelissa [Lisäävä päivitys Power BI Premiumissa](../admin/service-premium-incremental-refresh.md).
