...
Kun olet luonut Power BI -visualisoinnin, voit julkaista sen AppSourcessa, josta muutkin löytävät sen käyttöönsä. Jos haluat lisätietoja Power BI -visualisointien luomisesta, katso [Power BI -visualisoinnin kehittäminen](visuals/custom-visual-develop-tutorial.md).
