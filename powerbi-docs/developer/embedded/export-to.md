...
Varmista ennen ohjelmointirajapinnan käyttämistä, että seuraavat [järjestelmänvalvojan vuokraajan asetukset](../../admin/service-admin-portal.md#tenant-settings) ovat käytössä:
