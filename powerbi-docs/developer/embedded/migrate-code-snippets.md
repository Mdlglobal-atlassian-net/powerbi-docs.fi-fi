...
Alla olevat koodikatkelmat ovat esimerkkejä, joissa käytetään C#-ohjelmointikieltä ja [Power BI .NET SDK:ä](https://www.nuget.org/profiles/powerbi).
...
## <a name="push-dataset-and-report"></a>Push-tietojoukko ja raportti

Joudut luomaan uudelleen luotuun tietojoukkoon perustuvan raportin.

Tässä katkelmassa oletetaan, että push-tietojoukko on jo SaaS-ympäristön sisällä olevassa työtilassa. Lisätietoja Push API -rajapinnasta löytyy kohdasta [Tietojen siirtäminen Power BI -tietojoukkoon](../automation/walkthrough-push-data.md).
