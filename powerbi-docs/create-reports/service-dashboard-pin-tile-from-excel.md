...
2. [Yhdistä työkirjaan](../connect-data/service-excel-workbook-files.md) Power BI:ssä valitsemalla **Nouda tiedot > Tiedostot > OneDrive – Business** ja siirtymällä Excel-tiedoston tallennuspaikkaan. Valitse tiedosto ja sitten **Yhdistä > Yhdistä**.
...
[Tietojen noutaminen Excel-työkirjoista](../connect-data/service-excel-workbook-files.md)
