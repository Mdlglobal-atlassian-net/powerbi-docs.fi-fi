...
- [Rekisteröidy Power BI -palveluun](../fundamentals/service-self-service-signup-for-power-bi.md). Katso raporttien luominen Power BI Desktopissa kohdasta [Työpöydän raporttinäkymä](desktop-report-view.md). 
