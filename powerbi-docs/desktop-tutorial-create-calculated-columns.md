...
1.  Valitse **Enemmän vaihtoehtoja** (...) tai napsauta hiiren kakkospainikkeella Kentät-luettelon **ProductSubcategory**-taulukkoa ja valitse **Uusi sarake**. Tämä luo uuden sarakkeen ProductSubcategory-taulukkoon.
