---
title: Suuren tiheyden pistekaaviot Power BI
description: Suuren tiheyden pistekaaviot Power BI
...
On olemassa olosuhteissa **High-Density näytteenotto** ei voida soveltaa pistekaavioon ja alkuperäinen algoritmi. Nämä olosuhteet ovat seuraavat:
...
Ota käyttöön **High-Density näytteenotto**, valitse Pistekaavio, siirry **muotoilu** ruudussa Laajenna **yleiset** kortin ja liu'uttamalla kortin alalaidassa **High-Density näytteenotto** liukusäätimen asentoon **-** .
...
* **High-Density näytteenotto** algoritmi toimii vain käytettäessä reaaliaikaisia yhteyksiä Power BI-palveluun pohjautuviin malleihin, tuotuihin malleihin tai Directqueryyn.
