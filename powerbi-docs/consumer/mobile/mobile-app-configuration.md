...
| Avain | Tyyppi. | Arvot | Description |
|---|---|---|---|
...
| com.microsoft.powerbi.mobile.EnableMultiSelect | Boolean |  <nobr>Tosi</nobr><br><nobr>Epätosi</nobr> | Määritä, korvataanko nykyinen valinta arvopisteen napautuksella vai lisätäänkö se nykyiseen valintaan. |
