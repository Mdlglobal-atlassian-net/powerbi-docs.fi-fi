...
* [Palveluiden sisältöpaketit](end-user-connect-to-services.md), joissa on valmiita koontinäyttöjä, raportteja ja tietojoukkoja Salesforcen kaltaisille palveluille. Tietoyhteyden muodostamisen lisäksi Power BI tarjoaa valmiiksi luotuja koontinäyttöjä ja raportteja kaikille näille palveluille.
...
## <a name="am-i-limited-to-one-copy-of-power-bi-desktop-for-my-entire-company"></a>Enkö saa ladata kuin yhden Power BI Desktop -kopion koko yritykselleni?
...
Tässä on täydellinen luettelo [Power BI:n tukemista selaimista](end-user-browsers.md).
