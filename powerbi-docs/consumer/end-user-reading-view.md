...
Voit näyttää saman visualisoinnin ilman häiritseviä valikkopalkkeja, suodatinruutua ja muita ylimääräisiä osia valitsemalla **koko näytön** kuvakkeen yläreunan valikkoriviltä ![](media/end-user-reading-view/power-bi-focus-icon.png).
